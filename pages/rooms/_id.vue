<template>
  <div>
    <div class="timer">
      <input type="number" v-model="minute" placeholder="mm" min="0" max="60" :readonly="timerIsRunning">
      <span>:</span>
      <input type="number" v-model="second" placeholder="ss" min="0" max="59" :readonly="timerIsRunning">
    </div>
...
export default {
  ...
  methods: {
    checkTimerValidation() {
      ...
      if (timerSecond > 60) { timerSecond = 3600 }
